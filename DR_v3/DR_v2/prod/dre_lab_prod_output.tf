...
# # output "dre_team_nsg_rules_prod" {
# #   value = local.rules
# # }

# output "app_asg_id" {
#   value = azurerm_application_security_group.dre_team_app_asg.id
# }

output "nsg_rules" {
  value = module.nsg_local.nsg_rules
}

output "asg_ids" {
  value = module.nsg_local.asg_ids
}
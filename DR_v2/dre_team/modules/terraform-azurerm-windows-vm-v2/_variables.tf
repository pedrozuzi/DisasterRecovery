...
variable "disk_initializer_enabled" {
  description = "**OPTIONAL**: Should CustomScriptExtension be attached to all servers"
  type        = bool
  default     = true
}

variable "init_disk_enabled" {
  description = "**OPTIONAL**: Should init_disk initialize new data disks"
  type        = bool
  default     = true
}
...
variable "enable_replication" {
  description = "**OPTIONAL**: Should enable VM replication"
  type    = bool
  default = false
}

variable "replication_dr_rg_name_recovery_vault" {
  description = "Recovery Vault RG for the replication module"
  type        = string
  default     = ""
}

variable "replication_target_availability_set_id" {
  description = "Availability Set for the replication module"
  type        = string
  default     = ""
}

variable "replication_target_resource_group_id" {
  description = "Target RG ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_dr_compute_cus_subnet_name" {
  description = "Subnet ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_target_recovery_fabric_id" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_secondary_protection_container_id" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_replication_policy_id" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_primary_protection_container_name" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_secondary_fabric_id" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_primary_fabric_name" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_recovery_vault_name" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}

variable "replication_cache_storage_account_id" {
  description = "Target Recovery Fabric ID for the replication module"
  type        = string
  default     = ""
}
...
#   description = "Optional replication config"
#   type = object({
#     enable                            = optional(bool)
#     dr_rg_name_recovery_vault         = optional(string)
...
#     secondary_protection_container_id = optional(string)
#     policy_id                         = optional(string)
#     primary_protection_container_name = optional(string)
#     secondary_fabric_id               = optional(string)
#     primary_fabric_name               = optional(string)
#     dr_compute_cus_subnet_name        = optional(string)
#     recovery_vault_name               = optional(string)
#     cache_storage_account_id          = optional(string)
#   })
#   default = null
# }
...
# variable "replication" {
#   description = "Replication configuration for the VM"
#   type = object({
#     enable_replication                = bool
#     dr_rg_name_recovery_vault         = string
#     target_availability_set_id        = string
#     target_resource_group_id          = string
#     target_recovery_fabric_id         = string
#     secondary_protection_container_id = string
#     replication_policy_id             = string
#     primary_protection_container_name = string
#     secondary_fabric_id               = string
#     primary_fabric_name               = string
#     dr_compute_cus_subnet_name        = string
#     recovery_vault_name               = string
#     cache_storage_account_id          = string
#   })
# }

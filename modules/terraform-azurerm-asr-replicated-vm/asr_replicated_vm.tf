...
#   # OS Disk
#   managed_disk {
#     disk_id                    = module.vm_module.vm_os_disk_ids[count.index]
#     staging_storage_account_id = module.replication_module.cache_storage_account_id
#     target_resource_group_id   = module.replication_module.secondary_protection_container_id
...
#   # Data Disks
#   dynamic "managed_disk" {
#     for_each = try(module.vm_module.vm_data_disk_ids[count.index], [])
#     content {
#       disk_id                    = managed_disk.value
#       staging_storage_account_id = module.replication_module.cache_storage_account_id
#       target_resource_group_id   = module.replication_module.secondary_protection_container_id

...
module "replication_vm_app" {
  source                                 = "../../Terraform/DisasterRecovery/modules/terraform-azurerm-asr-replicated-vm"
  managed_disk_target_replica_disk_types = module.vm_app.managed_disk_types
  ...
  managed_disk_ids                       = module.vm_app.managed_disk_ids
  target_recovery_fabric_id              = azurerm_site_recovery_fabric.secondary_fabric.id
  vm_ids                                 = module.vm_app.vm_ids
  nic_ids                                = module.vm_app.nic_ids
  ...
  managed_disk_target_disk_types         = module.vm_app.managed_disk_types
  ...
  os_disk_ids                            = module.vm_app.os_disk_ids
  cache_storage_account_id               = azurerm_storage_account.primary_storage_account.id
  tag_support_group                      = "test"
  runbook_id                             = azurerm_automation_runbook.runbook_app_gateway.id
  tag_app_group_email                    = "tet"
  vm_names                               = module.vm_app.vm_names
}